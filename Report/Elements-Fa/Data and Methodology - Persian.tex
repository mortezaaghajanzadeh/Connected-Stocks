...
\input{Elements/pairsnumber} 
جفت دارای حداقل یک مالک مشترک شناسایی شده است که 
\input{Elements/PairPercent.tex}
...
\begin{figure}[htbp]
	\centering
	\caption{ حالت های مختلف عضویت جفت در گروه های کسب و کار}
	\label{g2-1}
...
\subsection{اندازه گیری مالکیت مشترک}
...
\end{itemize}
  ...
  \FloatBarrier
\subsection{محاسبه هم حرکتی شرکت }
\label{comovement}

...
\subsection{{Pair composition} }
	...
	If two firms have at least one common block-holder, We consider them as a pair. By this definition, there are 75412  unique pairs in entire periods, which is \input{Elements/PairPercent.tex}of possible pairs (\input{Elements/TotalPairNumberCal.tex}). As we expected, stocks in pairs have concentrated ownership relative to the total sample, and pairs have one common owner.

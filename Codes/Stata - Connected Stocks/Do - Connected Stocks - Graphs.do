...
binscatter monthlyρ_5_f NMFCA, ytitle("{&rho} {sub:ij,t+1}") nquantiles(100) note("This figure graphs the correlation of daily 4Factor+Industry residuals in month t+1"" against our measure of institutional connectedness.") xtitle("MFCAP*") line(qfit)title("Common Pairs")
graph export mcorr5.eps,replace
graph export mcorr5.png,replace


binscatter monthlyρ_5_f NMFCA , ytitle("{&rho} {sub:ij,t+1}") nquantiles(100) note("This figure graphs the correlation of daily 4Factor+Industry residuals in month t+1"" against our measure of institutional connectedness.") xtitle("MFCAP*")  title("Common Pairs") 
...
binscatter monthlyρ_5_f NMFCA , ytitle("{&rho} {sub:ij,t+1}") nquantiles(100) note("This figure graphs the correlation of daily 4Factor+Industry residuals in month t+1"" against our measure of institutional connectedness. Allow for discontinuity in median") xtitle("MFCAP*")  title("Common Pairs") rd(0)
...
binscatter monthlyρ_5_f NMFCA , ytitle("{&rho} {sub:ij,t+1}") nquantiles(100) note("This figure graphs the correlation of daily 4Factor+Industry residuals in month t+1"" against our measure of institutional connectedness. Allow for discontinuity in fourth quarter") xtitle("MFCAP*")  title("Common Pairs") rd(0.8659935)
...
binscatter monthlyρ_5_f MFCA ,ytitle("{&rho} {sub:ij,t+1}") nquantiles(100) xscale(log) note("This figure graphs the correlation of daily 4Factor+Industry residuals in monthh t+1"" against our measure of institutional connectedness.") xtitle("MFCAP") title("Common Pairs") legend( ring(0) col(2) label(1 "Separate Group") label(2 "Same Group") ) msymbol(Th S)  by(sbgroup)
graph export mcorr50bg.eps,replace
graph export mcorr50bg.png,replace



binscatter monthlyρ_5_f MFCA ,ytitle("{&rho} {sub:ij,t+1}") nquantiles(100) xscale(log) note("This figure graphs the correlation of daily 4Factor+Industry residuals in monthh t+1"" against our measure of institutional connectedness.") xtitle("MFCAP") title("Common Pairs") 
graph export mcorr50.eps,replace
graph export mcorr50.png,replace



binscatter monthlyρ_5_f lnMFCA ,ytitle("{&rho} {sub:ij,t+1}") nquantiles(100) note("This figure graphs the correlation of daily 4Factor+Industry residuals in monthh t+1"" against our measure of institutional connectedness.") xtitle("Ln(MFCAP)") title("Common Pairs")
graph export mcorr50Ln.eps,replace
graph export mcorr50Ln.png,replace


binscatter monthlyρ_5_f lnMFCA ,ytitle("{&rho} {sub:ij,t+1}") nquantiles(100) note("This figure graphs the correlation of daily 4Factor+Industry residuals in monthh t+1"" against our measure of institutional connectedness.") xtitle("Ln(MFCAP)") title("Common Pairs") legend( ring(0) col(2) label(1 "Separate Group") label(2 "Same Group") ) msymbol(Th S)  by(sbgroup)

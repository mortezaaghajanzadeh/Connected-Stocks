...
binscatter monthlyρ_5_f NMFCA , ytitle("{&rho} {sub:ij,t+1}") nquantiles(100) note("This figure graphs the correlation of daily 4Factor+Industry residuals in month t+1"" against our measure of institutional connectedness. Allow for discontinuity in median") xtitle("FCA*")  title("Common Pairs") rd(0)
graph export mcorr5lrd.eps,replace
graph export mcorr5lrd.png,replace

binscatter monthlyρ_5_f NMFCA , ytitle("{&rho} {sub:ij,t+1}") nquantiles(100) note("This figure graphs the correlation of daily 4Factor+Industry residuals in month t+1"" against our measure of institutional connectedness. Allow for discontinuity in median") xtitle("FCA*")  title("Common Pairs") rd(0) by(holder_act)  legend( ring(1) col(2) label(2 "Active Holder") label(1 "Passive Holder") ) msymbol(Th S) 

graph export mcorr5lrda.eps,replace
graph export mcorr5lrda.png,replace

binscatter monthlyρ_5_f NMFCA , ytitle("{&rho} {sub:ij,t+1}") nquantiles(100) note("This figure graphs the correlation of daily 4Factor+Industry residuals in month t+1"" against our measure of institutional connectedness. Allow for discontinuity in median") xtitle("FCA*")  title("Common Pairs") rd(0) by(sbgroup)  legend( ring(1) col(2) label(1 "Separate Group") label(2 "Same Group") ) msymbol(Th S) 
...
binscatter monthlyρ_5_f NMFCA , ytitle("{&rho} {sub:ij,t+1}") nquantiles(100) note("This figure graphs the correlation of daily 4Factor+Industry residuals in month t+1"" against our measure of institutional connectedness. Allow for discontinuity in fourth quarter") xtitle("FCA*")  title("Common Pairs") rd(0.8659166)
graph export Qmcorr5lrd.eps,replace
graph export Qmcorr5lrd.png,replace

binscatter monthlyρ_5_f NMFCA , ytitle("{&rho} {sub:ij,t+1}") nquantiles(100) note("This figure graphs the correlation of daily 4Factor+Industry residuals in month t+1"" against our measure of institutional connectedness. Allow for discontinuity in fourth quarter") xtitle("FCA*")  title("Common Pairs") rd(0.8659166) by(holder_act)  legend( ring(1) col(2) label(2 "Active Holder") label(1 "Passive Holder") ) msymbol(Th S) 

graph export Qmcorr5lrda.eps,replace
graph export Qmcorr5lrda.png,replace

binscatter monthlyρ_5_f NMFCA , ytitle("{&rho} {sub:ij,t+1}") nquantiles(100) note("This figure graphs the correlation of daily 4Factor+Industry residuals in month t+1"" against our measure of institutional connectedness. Allow for discontinuity in fourth quarter") xtitle("FCA*")  title("Common Pairs") rd(0.8659166) by(sbgroup)  legend( ring(1) col(2) label(1 "Separate Group") label(2 "Same Group") ) msymbol(Th S) 
...
binscatter monthlyρ_5_f NMFCA , ytitle("{&rho} {sub:ij,t+1}")  note("This figure graphs the correlation of daily 4Factor+Industry residuals in month t+1"" against our measure of institutional connectedness.") xtitle("FCA*")  title("Common Pairs") by(PairType) legend(col(3))  nquantiles(20)
graph export mcorrPairType.eps,replace
graph export mcorrPairType.png,replace


hist NMFCA  if PairType == 0,xtitle("FCA*")title("Hybrid")

graph export HybridNMFCAHist.eps,replace
graph export HybridNMFCAHist.png,replace

hist NMFCA  if PairType == 1,xtitle("FCA*")title("Small")

graph export SmallNMFCAHist.eps,replace
graph export SmallNMFCAHist.png,replace

hist NMFCA  if PairType == 2,xtitle("FCA*")title("Large")
...
binscatter monthlyρ_5_f NMFCA if NMFCA >= 0.8659166 , ytitle("{&rho} {sub:ij,t+1}") nquantiles(20) note("This figure graphs the correlation of daily 4Factor+Industry residuals in month t+1"" against our measure of institutional connectedness. Allow for discontinuity in fourth quarter") xtitle("FCA*")  title("Common Pairs") by(sbgroup)  legend( ring(1) col(2) label(1 "Separate Group") label(2 "Same Group") ) msymbol(Th S) 
graph export Qmcorr5lrdbgsubsample.eps,replace
graph export Qmcorr5lrdbgsubsample.png,replace

binscatter monthlyρ_5_f NMFCA if NMFCA >= 0.8659166 , ytitle("{&rho} {sub:ij,t+1}") nquantiles(40) note("This figure graphs the correlation of daily 4Factor+Industry residuals in month t+1"" against our measure of institutional connectedness. Allow for discontinuity in fourth quarter") xtitle("FCA*")  title("Common Pairs")  

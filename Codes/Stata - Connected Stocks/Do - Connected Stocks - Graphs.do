...
binscatter monthlyρ_5_f NMFCAP, ytitle("{&rho} {sub:ij,t+1}") nquantiles(20) note("This figure shows the stock return comovement and common ownership.") xtitle("FCAP*")
graph export mcorr5Polk.eps,replace
graph export mcorr5Polk.png,replace



binscatter monthlyρ_5_f NMFCA, ytitle("{&rho} {sub:ij,t+1}") nquantiles(20) by (sgroup) legend(pos(4) ring(0) col(1) label(1 "Separate Industry") label(2 "Same Industry") ) msymbol(Th S)  note("This figure shows the stock return comovement and common ownership.") xtitle("MFCAP*")
graph export mcorr5g.eps,replace
graph export mcorr5g.png,replace


binscatter monthlyρ_5_f NMFCA, ytitle("{&rho} {sub:ij,t+1}") nquantiles(20) by (sbgroup) legend(pos(4) ring(0) col(1) label(1 "Separate Group") label(2 "Same Group") ) msymbol(Th S)  note("This figure shows the stock return comovement and common ownership.") xtitle("MFCAP*")
graph export mcorr5bg.eps,replace
graph export mcorr5bg.png,replace

binscatter monthlyρ_5_f NMFCA, ytitle("{&rho} {sub:ij,t+1}") nquantiles(20) note("This figure shows the stock return comovement and common ownership.") xtitle("MFCAP*") line(qfit)
graph export mcorr5.eps,replace
graph export mcorr5.png,replace


binscatter monthlyρ_5_f NMFCA , ytitle("{&rho} {sub:ij,t+1}") nquantiles(20) note("This figure shows the stock return comovement and common ownership.") xtitle("MFCAP*")   
...
binscatter monthlyρ_5_f NMFCA , ytitle("{&rho} {sub:ij,t+1}") nquantiles(20) note("This figure shows the stock return comovement and common ownership." "Allow for discontinuity in median") xtitle("MFCAP*")   rd(0)
graph export mcorr5lrd.eps,replace
graph export mcorr5lrd.png,replace

binscatter monthlyρ_5_f NMFCA , ytitle("{&rho} {sub:ij,t+1}") nquantiles(20) note("This figure shows the stock return comovement and common ownership." "Allow for discontinuity in median") xtitle("MFCAP*")   rd(0) by(holder_act)  legend( ring(1) col(2) label(2 "Active Holder") label(1 "Passive Holder") ) msymbol(Th S) 

graph export mcorr5lrda.eps,replace
graph export mcorr5lrda.png,replace

binscatter monthlyρ_5_f NMFCA , ytitle("{&rho} {sub:ij,t+1}") nquantiles(20) note("This figure shows the stock return comovement and common ownership." "Allow for discontinuity in median") xtitle("MFCAP*")   rd(0) by(sbgroup)  legend( ring(1) col(2) label(1 "Separate Group") label(2 "Same Group") ) msymbol(Th S) 
...
binscatter monthlyρ_5_f NMFCA , ytitle("{&rho} {sub:ij,t+1}") nquantiles(20) note("This figure shows the stock return comovement and common ownership." "Allow for discontinuity in fourth quarter") xtitle("MFCAP*")   rd(0.8659935)
graph export Qmcorr5lrd.eps,replace
graph export Qmcorr5lrd.png,replace

binscatter monthlyρ_5_f NMFCA , ytitle("{&rho} {sub:ij,t+1}") nquantiles(20) note("This figure shows the stock return comovement and common ownership." "Allow for discontinuity in fourth quarter") xtitle("MFCAP*")   rd(0.8659935) by(holder_act)  legend( ring(1) col(2) label(2 "Active Holder") label(1 "Passive Holder") ) msymbol(Th S) 

graph export Qmcorr5lrda.eps,replace
graph export Qmcorr5lrda.png,replace

binscatter monthlyρ_5_f NMFCA , ytitle("{&rho} {sub:ij,t+1}") nquantiles(20) note("This figure shows the stock return comovement and common ownership." "Allow for discontinuity in fourth quarter") xtitle("MFCAP*")   rd(0.8659935) by(sbgroup)  legend( ring(1) col(2) label(1 "Separate Group") label(2 "Same Group") ) msymbol(Th S) 
graph export Qmcorr5lrdbg.eps,replace
graph export Qmcorr5lrdbg.png,replace

/**/
binscatter monthlyρ_5_f NMFCA,  ytitle("{&rho} {sub:ij,t+1}") nquantiles(20) note("This figure shows the stock return comovement and common ownership.")xtitle("MFCAP*")   by(holder_act)  legend( ring(1) col(2) label(2 "Active Holder") label(1 "Passive Holder") ) msymbol(Th S) line(qfit)

graph export mcorr5a.eps,replace
graph export mcorr5a.png,replace


binscatter monthlyρ_5_f MFCA ,ytitle("{&rho} {sub:ij,t+1}") nquantiles(20) xscale(log) note("This figure shows the stock return comovement and common ownership.") xtitle("MFCAP")  legend( ring(0) col(2) label(1 "Separate Group") label(2 "Same Group") ) msymbol(Th S)  by(sbgroup)
graph export mcorr50bg.eps,replace
graph export mcorr50bg.png,replace



binscatter monthlyρ_5_f MFCA ,ytitle("{&rho} {sub:ij,t+1}") nquantiles(20) xscale(log) note("This figure shows the stock return comovement and common ownership.") xtitle("MFCAP")  
graph export mcorr50.eps,replace
graph export mcorr50.png,replace


binscatter monthlyρ_5_f lnMFCA ,ytitle("{&rho} {sub:ij,t+1}") nquantiles(20) note("This figure shows the stock return comovement and common ownership.") xtitle("Ln(MFCAP)") 
graph export mcorr50Ln.eps,replace
graph export mcorr50Ln.png,replace


binscatter monthlyρ_5_f lnMFCA ,ytitle("{&rho} {sub:ij,t+1}") nquantiles(20) note("This figure shows the stock return comovement and common ownership.") xtitle("Ln(MFCAP)")  legend( ring(0) col(2) label(1 "Separate Group") label(2 "Same Group") ) msymbol(Th S)  by(sbgroup)
graph export mcorr50LnSb.eps,replace
graph export mcorr50LnSb.png,replace



binscatter monthlyρ_5_f NMFCA , ytitle("{&rho} {sub:ij,t+1}")  note("This figure shows the stock return comovement and common ownership.") xtitle("MFCAP*")   by(PairType) legend(col(3))  nquantiles(20)
...
binscatter monthlyρ_5_f NMFCA if forthquarter == 1 , ytitle("{&rho} {sub:ij,t+1}") nquantiles(20) note("This figure shows the stock return comovement and common ownership for the pairs in" "the fourth quarter.") xtitle("MFCAP*")   by(sbgroup)  legend( ring(1) col(2) label(1 "Separate Group") label(2 "Same Group") ) msymbol(Th S) 
graph export Qmcorr5lrdbgsubsample.eps,replace
graph export Qmcorr5lrdbgsubsample.png,replace

binscatter monthlyρ_5_f NMFCA if forthquarter == 1 , ytitle("{&rho} {sub:ij,t+1}") nquantiles(40) note("This figure shows the stock return comovement and common ownership for the pairs in" "the fourth quarter.") xtitle("MFCAP*")    

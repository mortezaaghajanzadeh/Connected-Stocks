...
tt["Coef_deltagroup_x"] = tt.set_index(["uo_x", "year_of_year"]).index.map(mapingdict)
tt["Coef_deltagroup_y"] = tt.set_index(["uo_y", "year_of_year"]).index.map(mapingdict)

mapingdict = dict(zip(tempt.index, tempt.highBeta))
tt["highBeta_x"] = tt.set_index(["uo_x", "year_of_year"]).index.map(mapingdict)
tt["highBeta_y"] = tt.set_index(["uo_y", "year_of_year"]).index.map(mapingdict)
tt
#%%

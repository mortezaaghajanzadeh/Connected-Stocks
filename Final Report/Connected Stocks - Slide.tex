...
\title[How are stocks connected? ]{How are stocks connected?}
...
%	\end{frame}
	...
	\begin{frame}{Future Correlation via $ MFCAP $}
		\begin{figure}
			\centering  
...
%	
	...
	%
	%
		\begin{frame}{ 4 Factor + Industry Future  Correlation via $ MFCAP^* $}{Discontinuity \&  Business Groups}\label{Monthly19}

...
Table \ref{mresult2} reports results from forecasting cross-sectional variation in pair's co-movement. In the two first columns, we estimate a simplified version of equation \ref{model1} with only Same Group as a control variable. In the first column, we estimate the model without control variables. We find that Same Group is highly significant, with a coefficient of 0.0128 and a t-statistic of 6.29, in the presence of control variables.

...
So, this dummy is equal to one if at least one pair's firms belong to the low imbalance std business group. Table \ref{Imbalance} reports estimation results for 
\begin{table}[htbp]
	\centering
	\caption{text}
	\label{Imbalance}
